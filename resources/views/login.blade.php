        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
                <div
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('login.procces') }}">
                        @csrf
                        <div class="mb-10">
                            ...
                            {{-- <p class="text-sm mt-4">Sign in to your account and explore a world of possibilities. Your
                        ...
                        {{-- <div class="w-full h-10 bg-blue-500 rounded-md ">
                            <button class="align-center" type="submit">
                                Login
                            </button>
