        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
                <div
                    ...
                    <form class="space-y-6" action="{{ route('register.procces') }}" method="POST">
                        @csrf
                        <div class="mb-4 text-center">
                            <h3 class="text-3xl text-blue-700 font-bold">E-RealEstate</h3>
                            <h1>Website Prediksi Nilai Properti di Wilayah Surabaya dan Sekitarnya</h1>
                        </div>
                        <div class="mb-10">
                        ...
                        <div>
                            <label class="text-sm mb-2 block">Nama</label>
                        ...
                        <div class="!mt-10">
                            <button type="submit" 
                                class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-blue-500 hover:bg-black focus:outline-none">
                                Register
                            </button>
                        </div>
                        <p class="text-sm !mt-10 text-center">Sudah punya akun? <a href="{{route('login')}}"
                                class="text-blue-600 hover:underline ml-1 whitespace-nowrap">Login here</a></p>
                    </form>
                </div>
